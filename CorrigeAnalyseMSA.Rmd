---
title: |
  <img src="logo_uimm_placeholder.jpg" alt="Logo UIMM" style="float: right; height: 72px; margin-left: 24px;">
  <span style="font-size: 0.8em; font-weight: bold;">TP & Analyse de Données : Qualification de Performance d'un Robot FANUC</span>
author: "S. JAUBERT"
...
<<<<<<< HEAD:Corrigé Analyse  MSA.Rmd
Conclusion de l'ANOVA : Il n'y a pas de différence statistiquement significative entre les moyennes des trois comparateurs. Notre système de mesure est validé !
  
=======
**Conclusion de l'ANOVA** : Il n'y a pas de différence statistiquement significative entre les moyennes des trois comparateurs.

>>>>>>> 66767a70e1b5e44440c942f64d4565b3b5a4a5cf:CorrigeAnalyseMSA.Rmd
...
<<<<<<< HEAD:Corrigé Analyse  MSA.Rmd
Pour les axes X, Y, et Z, toutes les $p_{values}$ sont > 0.05.Conclusion : Nous considérons que les données sont normalement distribuées. Le procédé est stable et prévisible.
=======
